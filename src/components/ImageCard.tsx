    ...
    return (
        <div className="mb-6 break-inside-avoid relative group overflow-hidden rounded-xl bg-gray-900/50 hover:shadow-xl transition-all duration-500 ease-in-out border border-white/5">
            <div className="relative w-full overflow-hidden">
                <a href={artwork.image_url} target="_blank" rel="noopener noreferrer" className="block">
                    <img
                        src={artwork.image_url}
                        alt={artwork.title}
                        loading="lazy"
                        className="w-full h-auto object-cover transform group-hover:scale-105 transition-transform duration-700 ease-out min-h-[150px] cursor-pointer"
